            ...
            <motion.div variants={fadeInUp} className="mb-12">
              ...
              <div className="flex justify-center mb-8">
                <motion.img
                  ...
                  className={`border ${isDark ? 'border-gray-600' : 'border-gray-300'} rounded transition-all duration-300 w-full max-w-5xl h-auto cursor-pointer`}
                />
              </div>
            ...
            <motion.div variants={fadeInUp} className="mb-12">
              ...
              <div className="flex justify-center mb-8">
                <motion.img
                  ...
                  alt="Profile Details" 
                  className={`border ${isDark ? 'border-gray-600' : 'border-gray-300'} rounded transition-all duration-300 w-full max-w-3xl cursor-pointer`}
                />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-x-48 gap-y-6 mb-8 max-w-4xl mx-auto">
                <div className="flex justify-center">
                  <motion.img
                    ...
                    className={`border ${isDark ? 'border-gray-600' : 'border-gray-300'} rounded transition-all duration-300 w-full cursor-pointer`}
                  />
                </div>
                <div className="flex justify-center">
                  <motion.img
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`ml-6 px-4 py-2 rounded ${isDark ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-100 hover:bg-gray-200'} transition-all duration-300 flex items-center space-x-2`}
                >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <motion.div variants={fadeInUp} className="space-y-6">
                ...
                <motion.a
                  ...
                  className={`flex items-center p-6 border ${isDark ? 'border-gray-600' : 'border-gray-300'} rounded ${isDark ? 'hover:border-white hover:shadow-lg hover:shadow-white/10' : 'hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/10'} transition-all duration-300 group`}
                >
                  <div className={`w-12 h-12 rounded-full border ${isDark ? 'border-gray-600 group-hover:border-white group-hover:bg-white/5' : 'border-gray-300 group-hover:border-blue-500 group-hover:bg-blue-50'} flex items-center justify-center mr-4 transition-all duration-300`}>
                    <svg className={`w-6 h-6 ${isDark ? 'text-gray-400 group-hover:text-white' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className={`font-medium ${isDark ? 'text-white group-hover:text-gray-200' : 'text-gray-900 group-hover:text-blue-600'} transition-colors duration-300`}>Email</h4>
                    <p className={`text-sm ${isDark ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`}>Contact me</p>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <h4 className={`font-medium ${isDark ? 'text-white group-hover:text-gray-200' : 'text-gray-900 group-hover:text-blue-600'} transition-colors duration-300`}>Phone</h4>
                    <p className={`text-sm ${isDark ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`}>Call me</p>
                  </div>
                </motion.a>
                ...
                >
                  <div className={`w-12 h-12 rounded-full border ${isDark ? 'border-gray-600 group-hover:border-white group-hover:bg-white/5' : 'border-gray-300 group-hover:border-blue-500 group-hover:bg-blue-50'} flex items-center justify-center mr-4 transition-all duration-300`}>
                    <svg className={`w-6 h-6 ${isDark ? 'text-gray-400 group-hover:text-white' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`} fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h4 className={`font-medium ${isDark ? 'text-white group-hover:text-gray-200' : 'text-gray-900 group-hover:text-blue-600'} transition-colors duration-300`}>GitHub</h4>
                    <p className={`text-sm ${isDark ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`}>View projects</p>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <h4 className={`font-medium ${isDark ? 'text-white group-hover:text-gray-200' : 'text-gray-900 group-hover:text-blue-600'} transition-colors duration-300`}>LinkedIn</h4>
                    <p className={`text-sm ${isDark ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-blue-500'} transition-colors duration-300`}>Connect with me</p>
                  </div>
                </motion.a>
              </motion.div>
                ...
                >
                  <motion.div variants={fadeInUp}>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className={`w-full bg-transparent border ${isDark ? 'border-gray-600 focus:border-white' : 'border-gray-300 focus:border-blue-500'} rounded px-4 py-3 ${isDark ? 'text-white placeholder-gray-500' : 'text-gray-900 placeholder-gray-400'} focus:outline-none focus:ring-1 ${isDark ? 'focus:ring-white/20' : 'focus:ring-blue-500/20'} transition-all duration-300`}
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={`w-full ${isDark ? 'bg-white text-black hover:bg-gray-200' : 'bg-blue-500 text-white hover:bg-blue-600'} py-3 px-6 rounded font-medium transition-all duration-300 flex items-center justify-center group`}
                  >
